...
/*   Updated: 2025/04/18 21:47:49 by lukorman         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	game->textures.floor = mlx_load_png("textures/background.png");
	if (!game->textures.floor)
	{
		ft_printf("Error loading floor texture\n");
		exit(EXIT_FAILURE);
	}
	game->textures.collectible = mlx_load_png("textures/collect_trash.png");
	...
	game->textures.player = mlx_load_png("textures/player_alien.png");
	if (!game->textures.player)
	{
		ft_printf("Error loading player texture\n");
		exit(EXIT_FAILURE);
	}
	game->textures.wall = mlx_load_png("textures/wall_fire.png");
